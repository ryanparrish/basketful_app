    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='voucher_logs', to='food_orders.order')),
                ('participant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='voucher_logs', to='food_orders.participant')),
